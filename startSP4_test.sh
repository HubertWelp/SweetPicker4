...
echo $IP_ADRESS_KOORDINATOR	 

# Launch all components in tabs
gnome-terminal \
    --tab --title="SP4 Bildanalysator" \
        --command="bash -c 'echo -e \"\e[1;34m===== SP4 Bildanalysator --IP $IP_ADRESS_KOORDINATOR =====\e[0m\"; sleep 3; /home/student/git/SP4/SweetPicker4/build-SP4Bildanalysator-Desktop_Qt_6_2_3_GCC_64bit-Debug/SP4Bildanalysator_2 --IP $IP_ADRESS_KOORDINATOR; exec bash'" \
    --tab --title="SP4 Admin" \
